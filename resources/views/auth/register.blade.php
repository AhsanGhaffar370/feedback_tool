      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10">
        <div class="col-xl-8 col-lg-8 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="{{ route('store.user.register') }}">
                @csrf
                <div class="row">
                  <div class="form-group col-md-6">
                    <label >Firstname</label>
                    <input id="firstname" type="text" 
                    placeholder="First Name" class="form-control @error('firstname') is-invalid @enderror" name="firstname" 
                  ...
                  <div class="form-group col-md-6">
                    ...
                    placeholder="First Name" class="form-control @error('lastname') is-invalid @enderror" name="lastname" 
                ...
                <div class="row">
                  <div class="form-group col-md-4">
                    ...
                    placeholder="State" class="form-control @error('state') is-invalid @enderror" name="state" 
                  ...
                  <div class="form-group col-md-4">
                    ...
                    placeholder="City" class="form-control @error('city') is-invalid @enderror" name="city" 
                  ...
                  <div class="form-group col-md-4">
                    ...
                    placeholder="Zipcode" class="form-control @error('zipcode') is-invalid @enderror" name="zipcode" 
